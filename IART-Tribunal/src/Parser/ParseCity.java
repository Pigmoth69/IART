	...
	private void loadCities() throws IOException{
        ...
        for(Element e: elements){
        	if(e.childNodeSize() !=1 && e.childNodeSize() !=5){
        		...
        		if(name.contains("(Madeira)") || name.contains("(A�ores)")|| name.contains("Funchal")||
        		   name.contains("Ponta Delgada")|| name.contains("Santa Cruz")||name.contains("C�mara de Lobos")||
        		   name.contains("Angra do Hero�smo")||name.contains("Ribeira Grande")||name.contains("Machico")||
        		   name.contains("Praia da Vit�ria")||name.contains("Horta")||name.contains("Vila Franca do Campo")||
        		   name.contains("Santana")||name.contains("Povoa��o")||name.contains("Madalena")||name.contains("S�o Vicente")||
        		   ...
        		   name.contains("S�o Roque do Pico")||name.contains("Porto Moniz")||name.contains("Santa Cruz das Flores")||
